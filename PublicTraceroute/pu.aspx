<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="pu.aspx.cs" Inherits="MainPage" %>
...
<tr>
    ...
    <div>
        ...
        <div id="outerdiv">
            <iframe id="I1" runat="server" align="center" frameborder="0" height="278" 
                marginheight="0px" marginwidth="0px" name="I1" 
                src="http://revtr.cs.washington.edu" title="Washigton.edu" type="text/html" 
                width="500"></iframe>
        </div>

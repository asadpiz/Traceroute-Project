    ...
    if (ind>0):
        ...
        while (k<ind):
            if (z[ind]==z[k]):
                ...
                descfile.write('<tr><td width="400">'+str(ind)+'</td><td width="500">'+str(ipS[ind])+'</td><td width="500">'+ str(ispS[ind])+'</td><td width="500">'+str(tag[ind])+'</td><td width="500">'+rttave[ind]+'/td></tr>\n</table>')
                descfile.close()
...
##        print (z[ind])
        ...
        descfile.write('<table>\n<tr><td width="400">Hop No.</td><td width="500">IP Address</td><td width="500">ISP</td><td width="500">Methood</td><td width="500">Average RTTasdaaaaaaaaasadullah\n')
